...
DEFAULT_CRYPTO_PRICE_PROVIDER = "coingecko_then_twelve"
...
CRYPTO_PROVIDER_COINGECKO_THEN_TWELVE = "coingecko_then_twelve"
CRYPTO_PROVIDER_TWELVE_ONLY = "twelve_data_only"
SUPPORTED_PROVIDERS = [PROVIDER_TWELVE_DATA]
SUPPORTED_CRYPTO_PRICE_PROVIDERS = [
    CRYPTO_PROVIDER_COINGECKO_THEN_TWELVE,
    CRYPTO_PROVIDER_TWELVE_ONLY,
]
